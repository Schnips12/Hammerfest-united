...
public class ViewManager : MonoBehaviour
{
    ...
    // TODO need to recrite basically everything.
    /* Basically we have to freeze the game, move the assets in the transition direction to the next level, and add transition effetcs. */
