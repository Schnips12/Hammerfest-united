...
/*         xSub = subs[0]._x; // FIXME
    ...
    protected void WallWalk()
    {
        ...
        choices.Add(new choice(1, 0, 0, 1));    // Droite sous plafond
        choices.Add(new choice(-1, 0, 0, 1));   // Gauche sous plafond
        choices.Add(new choice(1, 0, 0, -1));   // Droite sur sol
        choices.Add(new choice(-1, 0, 0, -1));  // Gauche sur sol
        choices.Add(new choice(0, 1, 1, 0));    // Haut sur droite
        choices.Add(new choice(0, -1, 1, 0));   // Bas sur droite
        choices.Add(new choice(0, 1, -1, 0));   // Haut sur gauche
        choices.Add(new choice(0, -1, -1, 0));  // Bas sur gauche
    ...
    void WallWalkIA()
    {
        ...
        int dirX = (dx==null || dx==0) ? 0 : Mathf.RoundToInt(Mathf.Sign(dx.Value));
        int dirY = (dy==null || dy==0) ? 0 : Mathf.RoundToInt(Mathf.Sign(dy.Value));
